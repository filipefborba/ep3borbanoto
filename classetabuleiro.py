...
class Tabuleiro():
    ...
    def __init__(self):
        ...
        self.window.geometry("400x330+100+100")
    ...
    #Criando a Label dos turnos:      
        ...
        self.label_turno.grid(row=3, column=0, sticky="nsew")
        self.label_turno.configure(text="Turno:", bg='Black', fg='Green')
        
        
        self.label_turno = tk.Label(self.window)
        self.label_turno.grid(row=3, column=1, columnspan=3, sticky="nsew")
        self.label_turno.configure(text="{0}" .format(self.jogo.player), bg='Black', fg='Green')
        
    #Criando Botão de Reiniciar:
        
        self.reiniciar = tk.Button(self.window)
        self.reiniciar.grid(row=1, column=3,columnspan=1, sticky="nsew")
    ...
    #Criando o Placar:
        ...
        self.vitorias_X.grid(row=0, column=3, sticky="nsew")
        ...
        self.vitorias_O.grid(row=2, column=3, sticky="nsew")
...
############         fg=self.jogo.color
    ...
    def botão0x0_clicado(self):
        ...
        self.label_turno.configure(text="{0}" .format(self.jogo.player))
