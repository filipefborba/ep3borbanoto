...
class Tabuleiro():
    ...
    #Criando a Label dos turnos:      
        ...
        self.label_turno.grid(row=3, columnspan=2, sticky="nsew")
        self.label_turno.configure(text="Turno de: {0}" .format(self.jogo.player), bg='Black', fg='Green')
        
        
    #Criando Botão de Reiniciar:
        
        self.reiniciar = tk.Button(self.window)
        self.reiniciar.grid(row=3, column=2, sticky="nsew")
